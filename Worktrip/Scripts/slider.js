(function(j, f, c, i, d, l, g) { /*! Jssor */
    ...
    var b = new function() {
        ...
        h.Wg = function(d, a) {
            if (a) d.style.clip = "rect(" + c.round(a.$Top || a.I || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.D || 0) + "px)";
            else if (a !== g) {
            ...
            a.ae = function(c, b) {
                ...
                if (!a.Pb[f]) {
                    ...
                    for (var d = 0; d < a.$Cols; d++)
                        for (var e = 0; e < a.$Rows; e++) a.Pb[f][e + "," + d] = {
                            $Top: e * b,
                            $Right: d * c + c,
                            $Bottom: e * b + b,
                            $Left: d * c
            ...
            function T(a, c, e) {
                ...
                b.a(f, function(f) {
                    ...
                    if (i == "caption") {
                        ...
                        if (h == "A") {
                            if (b.j(f, "u") == "image") o = b.Jf(f, "IMG");
                            else o = b.v(f, "image", d);
                            if (o) {
                                w = f;
                                b.W(w, "block");
                                b.M(w, V);
